...
<head>
 ...
 <body>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="p_sidtal.php">Inicio <span class="sr-only">(current)</span></a>
      </li>
      
      </li>
     <li class="nav-item">
        <a class="nav-link" href="#">Registro Asistencia</a>
      </li>
    </ul>
  ...
  <div class="container">
    <div class="jumbotron">
      <h2 class="display-6">Menu de Usuario SIDTAL</h2>
